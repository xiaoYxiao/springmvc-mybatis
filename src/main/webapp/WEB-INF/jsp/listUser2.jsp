...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.json-2.3.js"></script>  
		...
		<script type="text/javascript">
			...
			function getResponseJson(){
				...
				var url = "${pageContext.request.contextPath}/demo/user/ajaxGetUser.do?"+param;
				jQuery.ajax( {  
			          type : 'get',  
			...
			　　		tr.append("<td><a href=\"${pageContext.request.contextPath}/demo/user/toUpdateUser.do?uid="+uid+"\">更新</a>|"+
									"<a href=\"${pageContext.request.contextPath}/demo/user/deleteUser.do?uid="+uid+"\">删除</a>|"+
									"<a href=\"${pageContext.request.contextPath}/demo/address/toAddNewAddress.do?uid="+uid+"\">添加新地址</a></td>");
				});
				fillTable();
			}
